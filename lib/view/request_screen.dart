...
class _RequestScreenState extends ConsumerState<RequestScreen> {
  ...
  void _saveExpense() {
    if (_nameController.text.isEmpty || _summaController.text.isEmpty) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("${incomeSnackBarAlert.tr}!")));
      return;
    }
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text(incomeAded.tr)));
  }
  ...
  Future<void> _getImage() async {
    ...
    if (pickedFile != null) {
      _requestImage = File(pickedFile.path);
      setState(() {});
    }
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Container(
                    alignment: _requestImage == null ? Alignment.center : null,
